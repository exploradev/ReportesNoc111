var filldetalles_aclaraciones,
  filldetalles_callback,
  filldetalles_cobertura,
  filldetalles_general,
  filldetalles_iccid,
  filldetalles_llamadas,
  filldetalles_navegacion,
  filldetalles_promociones,
  filldetalles_recargas,
  filldetalles_servicios;
$(document).ready(function () {
  //AL CLICKEAR EN LA TABLA DE REPORTES DISPONIBLES
  //MUESTRO EL MODAL DE DETALLES

  $("#tbody_reportesexistentes").on(
    "click",
    ".rowdetallesdisponibles",
    function () {
